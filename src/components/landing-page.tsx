    ...
    <>
      ...
      <main className="mt-10">
          ...
          <Card className="mx-auto max-w-[1120px] px-4 sm:px-0 relative hidden md:block rounded-3xl overflow-hidden p-8 bg-[url('/assets/images/tattoo-removal/hero-1.jpg')] bg-cover bg-center h-96">
            <div className="flex flex-col md:flex-row md:space-x-8 p-8 rounded-lg">
              <div className="text-white md:w-1/2 space-y-4">
                ...
                <Button className="bg-primaryOrange hover:bg-primaryOrange/90 text-white font-bold rounded-3xl">
                  Hemen Randevu Alın
                </Button>
              </div>
            </div>
        ...
        <section className="mx-auto max-w-[800px] px-4 sm:px-0 py-10 text-center">
          ...
          <Button className="bg-primaryOrange hover:bg-primaryOrange/90 text-white font-bold rounded-3xl mt-5">
            Hemen Randevu Alın
          </Button>
        </section>
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-center pt-10 px-24">
                <div className="text-white md:w-2/3 space-y-3 mb-10 mx-auto text-center md:text-left">
                  ...
                  <Button className="bg-primaryOrange hover:bg-primaryOrange/90 text-white font-normal rounded-3xl">
                    Detaylı Bilgi Alın
                  </Button>
                </div>
